import { _ as S, K as _r, c as g, L as rr, l as J, D as ar, E as A, H as Qt, T as Wt, C as I, M as C, d as Pr, e as cr, f as bs, g as fs, s as he, h as nr, i as Qi, j as $i, V as Ft, k as B, m as L, n as Yi, o as Zi, I as zt, p as Xi, q as Pt, r as es, A as ws, t as hs, u as xr, v as ms, w as vs, U as bn, x as $t, S as fn, y as wn, z as hn, B as ur, F as mn, G as x, J as T, N as ir, O as be, P as Gt, Q as N, R as ks } from "./main-zEQNmC7x.js";
...
class At {
  ...
  set deviceId(e) {
    let t = 0;
    h(e) || (f(e, D), t = e.__destroy_into_raw()), n.__wbg_set_basemigrationdata_deviceId(this.__wbg_ptr, t);
  }
...
class q {
  ...
  eq(e) {
    return f(e, q), n.collectstrategy_eq(this.__wbg_ptr, e.__wbg_ptr) !== 0;
  }
...
class ke {
  ...
  encryptToDeviceEvent(e, t, r) {
    ...
    let _ = 0;
    return h(r) || (f(r, q), _ = r.__destroy_into_raw()), n.device_encryptToDeviceEvent(this.__wbg_ptr, s, o, t, _);
  }
  firstTimeSeen() {
...
class st {
  ...
  set forwarderDevice(e) {
    let t = 0;
    h(e) || (f(e, D), t = e.__destroy_into_raw()), n.__wbg_set_encryptioninfo_forwarderDevice(this.__wbg_ptr, t);
  }
  set forwarder(e) {
    let t = 0;
  ...
  set senderDevice(e) {
    let t = 0;
    h(e) || (f(e, D), t = e.__destroy_into_raw()), n.__wbg_set_encryptioninfo_senderDevice(this.__wbg_ptr, t);
  }
  set sender(e) {
    f(e, w);
...
class Oe {
  ...
  getDevice(e, t, r) {
    return f(e, w), f(t, D), n.olmmachine_getDevice(this.__wbg_ptr, e.__wbg_ptr, t.__wbg_ptr, !h(r), h(r) ? 0 : r);
  }
  getIdentity(e) {
  ...
  static initFromStore(e, t, r, s) {
    return f(e, w), f(t, D), f(r, P), n.olmmachine_initFromStore(e.__wbg_ptr, t.__wbg_ptr, r.__wbg_ptr, h(s) ? 0 : E(s));
  }
...
Symbol.dispose && (ie.prototype[Symbol.dispose] = ie.prototype.free);
const Ds = Object.freeze({ Login: 0, 0: "Login", Reciprocate: 1, 1: "Reciprocate" });
class ft {
  static __wrap(e) {
  ...
  set msc4108(e) {
    let t = 0;
    h(e) || (f(e, Ce), t = e.__destroy_into_raw()), n.__wbg_set_qrcodeintentdata_msc4108(this.__wbg_ptr, t);
  }
  set msc4388(e) {
    let t = 0;
...
const Cs = Object.freeze({ KeysUpload: 0, 0: "KeysUpload", KeysQuery: 1, 1: "KeysQuery", KeysClaim: 2, 2: "KeysClaim", ToDevice: 3, 3: "ToDevice", SignatureUpload: 4, 4: "SignatureUpload", RoomMessage: 5, 5: "RoomMessage", KeysBackup: 6, 6: "KeysBackup" });
class R {
  static __wrap(e) {
  ...
  constructor(e) {
    ...
    if (s[2]) throw l(s[1]);
    return this.__wbg_ptr = s[0], Dr.register(this, this.__wbg_ptr, this), this;
  }
  toString() {
    let e, t;
    try {
...
class Ue {
  ...
  constructor(e, t, r, s, o) {
    ...
    return this.__wbg_ptr = _, Cr.register(this, this.__wbg_ptr, this), this;
  }
  get type() {
...
class It {
  ...
  set senderDevice(e) {
    let t = 0;
    h(e) || (f(e, D), t = e.__destroy_into_raw()), n.__wbg_set_todeviceencryptioninfo_senderDevice(this.__wbg_ptr, t);
  }
  set sender(e) {
    f(e, w);
    var t = e.__destroy_into_raw();
...
} } : new FinalizationRegistry((i) => n.__wbg_checkcode_free(i, 1)), Dn = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((i) => n.__wbg_collectstrategy_free(i, 1)), Cn = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
...
} } : new FinalizationRegistry((i) => n.__wbg_rehydrateddevice_free(i, 1)), Dr = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
...
} } : new FinalizationRegistry((i) => n.__wbg_roomkeywithheldinfo_free(i, 1)), Cr = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
...
} } : new FinalizationRegistry((i) => n.__wbg_signatures_free(i, 1)), Di = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((i) => n.__wbg_storehandle_free(i, 1)), Ci = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
...
var jt = "/_matrix/client/unstable/org.matrix.msc3814.v1", Tr = "org.matrix.msc3814", Dg = 7 * 24 * 60 * 60 * 1e3;
class Cg extends Wt {
  constructor(e, t, r, s, o) {
  ...
  isSupported() {
    ...
    return g(function* () {
      try {
        yield e.http.authedRequest(C.Get, "/dehydrated_device", void 0, void 0, { prefix: jt });
      } catch (r) {
        var t = r;
  ...
  rehydrateDeviceIfAvailable() {
    ...
    return g(function* () {
      ...
      var r;
      try {
        r = yield e.http.authedRequest(C.Get, "/dehydrated_device", void 0, void 0, { prefix: jt });
      } catch (k) {
        var s = k;
      ...
      var o = yield e.olmMachine.dehydratedDevices().rehydrate(t, new D(r.device_id), JSON.stringify(r.device_data));
      ...
      for (var _ = void 0, a = 0, c = 0, u = cr("/dehydrated_device/$device_id/events", { $device_id: r.device_id }); ; ) {
        var y = yield e.http.authedRequest(C.Post, u, void 0, _ ? { next_batch: _ } : {}, { prefix: jt });
  ...
  delete() {
    ...
    return g(function* () {
      e.stop();
      try {
        yield e.http.authedRequest(C.Delete, "/dehydrated_device", void 0, {}, { prefix: jt });
      } catch (r) {
        var t = r;
...
class Og {
  ...
  makeOutgoingRequest(e, t) {
    ...
    return g(function* () {
      var s;
      if (e instanceof Ie) s = yield r.requestWithRetry(C.Post, "/_matrix/client/v3/keys/upload", {}, e.body);
      else if (e instanceof ce) s = yield r.requestWithRetry(C.Post, "/_matrix/client/v3/keys/query", {}, e.body);
      else if (e instanceof Ke) s = yield r.requestWithRetry(C.Post, "/_matrix/client/v3/keys/claim", {}, e.body);
      else if (e instanceof pe) s = yield r.requestWithRetry(C.Post, "/_matrix/client/v3/keys/signatures/upload", {}, e.body);
      else if (e instanceof Re) s = yield r.requestWithRetry(C.Put, "/_matrix/client/v3/room_keys/keys", { version: e.version }, e.body);
...
class Tg extends Wt {
  ...
  setupKeyBackup(e) {
    ...
    return g(function* () {
      ...
      yield e(o);
      var _ = yield t.http.authedRequest(C.Post, "/room_keys/version", void 0, { algorithm: s.algorithm, auth_data: o }, { prefix: Pt.V3 });
  ...
  deleteKeyBackupVersion(e) {
    ...
    return g(function* () {
      ...
      yield t.http.authedRequest(C.Delete, r, void 0, void 0, { prefix: Pt.V3 }), t.activeBackupVersion === e && (t.serverBackupInfo = null, yield t.disableKeyBackup());
    })();
  }
  ...
  downloadKeyBackup(e) {
    return this.http.authedRequest(C.Get, "/room_keys/keys", { version: e }, void 0, { prefix: Pt.V3 });
  }
...
function Yr() {
  return Yr = g(function* (i, e) {
    try {
      ...
      return yield i.authedRequest(C.Get, t, void 0, void 0, { prefix: Pt.V3 });
    } catch (r) {
...
class xg {
  ...
  requestRoomKeyFromBackup(e, t, r) {
    ...
    return g(function* () {
      ...
      return yield s.http.authedRequest(C.Get, o, { version: e }, void 0, { prefix: Pt.V3 });
    })();
  }
  downloadKeysLoop() {
    var e = this;
...
class Ng extends Wt {
  ...
  maybeAcceptKeyBundle(e, t) {
    ...
    return g(function* () {
      ...
      try {
        var c = new URL(_);
        a = yield r.http.authedRequest(C.Get, c.pathname + c.search, {}, void 0, { rawResponseBody: true, prefix: "" });
      } catch (u) {
  ...
  setDeviceVerified(e, t) {
    ...
    return g(function* () {
      var o = r.length > 2 && r[2] !== void 0 ? r[2] : true, _ = yield s.olmMachine.getDevice(new w(e), new D(t));
  ...
  crossSignDevice(e) {
    var t = this;
    return g(function* () {
      var r = yield t.olmMachine.getDevice(new w(t.userId), new D(e));
  ...
  getDeviceVerificationStatus(e, t) {
    var r = this;
    return g(function* () {
      var s = yield r.olmMachine.getDevice(new w(e), new D(t));
      if (!s) return null;
      try {
  ...
  cancelStaleToDeviceVerifications(e) {
    var t = this;
    return g(function* () {
      var r = t.getVerificationRequestsToDeviceInProgress(t.userId);
      for (var s of r) if (s.transactionId !== e && s.phase !== B.Done && s.phase !== B.Cancelled) try {
        yield s.cancel();
      } catch (o) {
        t.logger.warn("Failed to cancel stale verification request ".concat(s.transactionId), o);
      }
    })();
  }
  ...
  sendVerificationRequestContent(e, t) {
    var r = this;
    return g(function* () {
      var s = wn(32), { event_id: o } = yield r.http.authedRequest(C.Put, "/_matrix/client/v3/rooms/".concat(encodeURIComponent(e), "/send/m.room.message/").concat(encodeURIComponent(s)), void 0, t, { prefix: "" });
      return o;
    })();
  }
  ...
  requestOwnUserVerification() {
    ...
    return g(function* () {
      ...
      yield e.cancelStaleToDeviceVerifications();
      try {
  ...
  requestDeviceVerification(e, t) {
    ...
    return g(function* () {
      ...
      yield r.cancelStaleToDeviceVerifications();
      try {
  ...
  encryptToDeviceMessages(e, t, r) {
    ...
    return g(function* () {
      ...
      return yield Promise.all(t.map(function() {
        var c = g(function* (u) {
          var { userId: y, deviceId: m } = u, k = yield s.olmMachine.getDevice(new w(y), new D(m));
          if (k) {
  ...
  shareRoomHistoryWithUser(e, t) {
    ...
    return g(function* () {
      ...
      var u = yield r.getOlmMachineOrThrow().shareRoomKeyBundleData(new w(t), new R(e), a.content_uri, _.mediaEncryptionInfo, q.identityBasedStrategy());
  ...
  onIncomingKeyVerificationRequest(e, t) {
    ...
    r ? (this.cancelStaleToDeviceVerifications(t).catch((s) => this.logger.warn("Failed to sweep stale verifications on incoming request", s)), this.emit(I.VerificationRequestReceived, this.makeVerificationRequest(r))) : this.logger.info("Ignoring just-received verification request ".concat(t, " which did not start a rust-side verification"));
  }
...
function Xr() {
  return Xr = g(function* (i, e, t, r, s, o, _) {
    var a = new At();
    a.userId = new w(e), a.deviceId = new D(t), yield r.doTxn("readonly", [Gt.STORE_ACCOUNT], (ee) => r.getAccount(ee, (Bt) => {
      a.pickledAccount = Bt ?? "";
    }));
...
function gn() {
  return gn = g(function* (i, e, t, r, s, o, _, a) {
    ...
    var c = yield Oe.initFromStore(new w(t), new D(r), _, i);
