...
var t = e(((e2) => {
  var t2 = /* @__PURE__ */ Symbol.for(`react.element`), n2 = /* @__PURE__ */ Symbol.for(`react.portal`), r2 = /* @__PURE__ */ Symbol.for(`react.fragment`), i2 = /* @__PURE__ */ Symbol.for(`react.strict_mode`), a = /* @__PURE__ */ Symbol.for(`react.profiler`), o = /* @__PURE__ */ Symbol.for(`react.provider`), s = /* @__PURE__ */ Symbol.for(`react.context`), c = /* @__PURE__ */ Symbol.for(`react.forward_ref`), l = /* @__PURE__ */ Symbol.for(`react.suspense`), u = /* @__PURE__ */ Symbol.for(`react.memo`), d = /* @__PURE__ */ Symbol.for(`react.lazy`), f = Symbol.iterator;
  function p(e3) {
  ...
  function T(e3, n3, r3) {
    ...
    if (n3 != null) for (i3 in n3.ref !== void 0 && (s2 = n3.ref), n3.key !== void 0 && (o2 = `` + n3.key), n3) S.call(n3, i3) && !w.hasOwnProperty(i3) && (a2[i3] = n3[i3]);
    var c2 = arguments.length - 2;
    if (c2 === 1) a2.children = r3;
    else if (1 < c2) {
      for (var l2 = Array(c2), u2 = 0; u2 < c2; u2++) l2[u2] = arguments[u2 + 2];
      a2.children = l2;
    }
    if (e3 && e3.defaultProps) for (i3 in c2 = e3.defaultProps, c2) a2[i3] === void 0 && (a2[i3] = c2[i3]);
  ...
  function j(e3, r3, i3, a2, o2) {
    ...
    if (c2) return c2 = e3, o2 = o2(c2), e3 = a2 === `` ? `.` + A(c2, 0) : a2, x(o2) ? (i3 = ``, e3 != null && (i3 = e3.replace(k, `$&/`) + `/`), j(o2, r3, i3, ``, function(e4) {
      return e4;
    })) : o2 != null && (D(o2) && (o2 = E(o2, i3 + (!o2.key || c2 && c2.key === o2.key ? `` : (`` + o2.key).replace(k, `$&/`) + `/`) + e3)), r3.push(o2)), 1;
    if (c2 = 0, a2 = a2 === `` ? `.` : a2 + `:`, x(e3)) for (var l2 = 0; l2 < e3.length; l2++) {
      s2 = e3[l2];
      var u2 = a2 + A(s2, l2);
      c2 += j(s2, r3, i3, u2, o2);
    }
    else if (u2 = p(e3), typeof u2 == `function`) for (e3 = u2.call(e3), l2 = 0; !(s2 = e3.next()).done; ) s2 = s2.value, u2 = a2 + A(s2, l2++), c2 += j(s2, r3, i3, u2, o2);
    else if (s2 === `object`) throw r3 = String(e3), Error(`Objects are not valid as a React child (found: ` + (r3 === `[object Object]` ? `object with keys {` + Object.keys(e3).join(`, `) + `}` : r3) + `). If you meant to render a collection of children, use an array instead.`);
    return c2;
  }
  function M(e3, t3, n3) {
  ...
  e2.Children = { map: M, forEach: function(e3, t3, n3) {
    ...
    if (!D(e3)) throw Error(`React.Children.only expected to receive a single React element child.`);
    return e3;
    ...
    if (n3 != null) {
      if (n3.ref !== void 0 && (o2 = n3.ref, s2 = C.current), n3.key !== void 0 && (a2 = `` + n3.key), e3.type && e3.type.defaultProps) var c2 = e3.type.defaultProps;
      for (l2 in n3) S.call(n3, l2) && !w.hasOwnProperty(l2) && (i3[l2] = n3[l2] === void 0 && c2 !== void 0 ? c2[l2] : n3[l2]);
    }
    var l2 = arguments.length - 2;
    if (l2 === 1) i3.children = r3;
    else if (1 < l2) {
      c2 = Array(l2);
  ...
  var t2 = n(), r2 = /* @__PURE__ */ Symbol.for(`react.element`), i2 = /* @__PURE__ */ Symbol.for(`react.fragment`), a = Object.prototype.hasOwnProperty, o = t2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, s = { key: true, ref: true, __self: true, __source: true };
  function c(e3, t3, n2) {
    var i3, c2 = {}, l = null, u = null;
    for (i3 in n2 !== void 0 && (l = `` + n2), t3.key !== void 0 && (l = `` + t3.key), t3.ref !== void 0 && (u = t3.ref), t3) a.call(t3, i3) && !s.hasOwnProperty(i3) && (c2[i3] = t3[i3]);
    if (e3 && e3.defaultProps) for (i3 in t3 = e3.defaultProps, t3) c2[i3] === void 0 && (c2[i3] = t3[i3]);
