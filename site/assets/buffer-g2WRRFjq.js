...
var t = e((e2) => {
  ...
  for (var t2 = [], n2 = [], r2 = typeof Uint8Array < `u` ? Uint8Array : Array, i = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/`, a = 0, o = i.length; a < o; ++a)
    t2[a] = i[a], n2[i.charCodeAt(a)] = a;
  n2[45] = 62, n2[95] = 63;
  function s(e3) {
    var t3 = e3.length;
    if (t3 % 4 > 0)
  ...
  function u(e3) {
    ...
    for (f2 = 0; f2 < d2; f2 += 4)
      t3 = n2[e3.charCodeAt(f2)] << 18 | n2[e3.charCodeAt(f2 + 1)] << 12 | n2[e3.charCodeAt(f2 + 2)] << 6 | n2[e3.charCodeAt(f2 + 3)], c2[u2++] = t3 >> 16 & 255, c2[u2++] = t3 >> 8 & 255, c2[u2++] = t3 & 255;
  ...
  function f(e3, t3, n3) {
    for (var r3, i2 = [], a2 = t3; a2 < n3; a2 += 3)
      r3 = (e3[a2] << 16 & 16711680) + (e3[a2 + 1] << 8 & 65280) + (e3[a2 + 2] & 255), i2.push(d(r3));
    return i2.join(``);
  }
  function p(e3) {
    for (var n3, r3 = e3.length, i2 = r3 % 3, a2 = [], o2 = 16383, s2 = 0, c2 = r3 - i2; s2 < c2; s2 += o2)
      a2.push(f(e3, s2, s2 + o2 > c2 ? c2 : s2 + o2));
  ...
  var r2 = t(), i = n(), a = typeof Symbol == `function` && typeof Symbol.for == `function` ? Symbol.for(`nodejs.util.inspect.custom`) : null;
  ...
  function c(e3) {
    if (e3 > o)
      throw RangeError(`The value "` + e3 + `" is invalid for option "size"`);
  ...
  function u(e3, t2, n2) {
    ...
    if (Z(e3, ArrayBuffer) || e3 && Z(e3.buffer, ArrayBuffer) || typeof SharedArrayBuffer < `u` && (Z(e3, SharedArrayBuffer) || e3 && Z(e3.buffer, SharedArrayBuffer)))
      return g(e3, t2, n2);
    if (typeof e3 == `number`)
      throw TypeError(`The "value" argument must not be of type number. Received type number`);
    let r3 = e3.valueOf && e3.valueOf();
    if (r3 != null && r3 !== e3)
      return l.from(r3, t2, n2);
    let i2 = _(e3);
    if (i2)
      return i2;
    if (typeof Symbol < `u` && Symbol.toPrimitive != null && typeof e3[Symbol.toPrimitive] == `function`)
      return l.from(e3[Symbol.toPrimitive](`string`), t2, n2);
    throw TypeError(`The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type ` + typeof e3);
  }
  ...
  function g(e3, t2, n2) {
    if (t2 < 0 || e3.byteLength < t2)
      throw RangeError(`"offset" is outside of buffer bounds`);
    if (e3.byteLength < t2 + (n2 || 0))
  ...
  function _(e3) {
    ...
    if (e3.length !== void 0)
      return typeof e3.length != `number` || Q(e3.length) ? c(0) : h(e3);
  ...
  l.isBuffer = function(e3) {
    ...
    if (Z(e3, Uint8Array) && (e3 = l.from(e3, e3.offset, e3.byteLength)), Z(t2, Uint8Array) && (t2 = l.from(t2, t2.offset, t2.byteLength)), !l.isBuffer(e3) || !l.isBuffer(t2))
      throw TypeError(`The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array`);
    if (e3 === t2)
      return 0;
    let n2 = e3.length, r3 = t2.length;
    for (let i2 = 0, a2 = Math.min(n2, r3); i2 < a2; ++i2)
      if (e3[i2] !== t2[i2]) {
        n2 = e3[i2], r3 = t2[i2];
        break;
      }
    ...
    for (n2 = 0; n2 < e3.length; ++n2) {
      let t3 = e3[n2];
      if (Z(t3, Uint8Array))
        i2 + t3.length > r3.length ? (l.isBuffer(t3) || (t3 = l.from(t3)), t3.copy(r3, i2)) : Uint8Array.prototype.set.call(r3, t3, i2);
      else if (l.isBuffer(t3))
        t3.copy(r3, i2);
      else
        throw TypeError(`"list" argument must be an Array of Buffers`);
      i2 += t3.length;
  ...
  function b(e3, t2) {
    ...
    if (typeof e3 != `string`)
      throw TypeError(`The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type ` + typeof e3);
  ...
  function x(e3, t2, n2) {
    let r3 = false;
    if ((t2 === void 0 || t2 < 0) && (t2 = 0), t2 > this.length || ((n2 === void 0 || n2 > this.length) && (n2 = this.length), n2 <= 0) || (n2 >>>= 0, t2 >>>= 0, n2 <= t2))
      return ``;
    for (e3 || (e3 = `utf8`); ; )
      switch (e3) {
        case `hex`:
        ...
        default:
          if (r3)
            throw TypeError(`Unknown encoding: ` + e3);
  ...
  l.prototype.swap16 = function() {
    ...
    for (let t2 = 0; t2 < e3; t2 += 4)
      S(this, t2, t2 + 3), S(this, t2 + 1, t2 + 2);
    return this;
    ...
    for (let t2 = 0; t2 < e3; t2 += 8)
      S(this, t2, t2 + 7), S(this, t2 + 1, t2 + 6), S(this, t2 + 2, t2 + 5), S(this, t2 + 3, t2 + 4);
    return this;
    ...
    if (Z(e3, Uint8Array) && (e3 = l.from(e3, e3.offset, e3.byteLength)), !l.isBuffer(e3))
      throw TypeError(`The "target" argument must be one of type Buffer or Uint8Array. Received type ` + typeof e3);
    if (t2 === void 0 && (t2 = 0), n2 === void 0 && (n2 = e3 ? e3.length : 0), r3 === void 0 && (r3 = 0), i2 === void 0 && (i2 = this.length), t2 < 0 || n2 > e3.length || r3 < 0 || i2 > this.length)
    ...
    if (t2 >= n2)
      return 1;
    if (t2 >>>= 0, n2 >>>= 0, r3 >>>= 0, i2 >>>= 0, this === e3)
      return 0;
  ...
  function C(e3, t2, n2, r3, i2) {
    ...
    if (typeof n2 == `string` ? (r3 = n2, n2 = 0) : n2 > 2147483647 ? n2 = 2147483647 : n2 < -2147483648 && (n2 = -2147483648), n2 = +n2, Q(n2) && (n2 = i2 ? 0 : e3.length - 1), n2 < 0 && (n2 = e3.length + n2), n2 >= e3.length) {
      ...
      if (i2)
        ...
        return -1;
    if (typeof t2 == `string` && (t2 = l.from(t2, r3)), l.isBuffer(t2))
      return t2.length === 0 ? -1 : w(e3, t2, n2, r3, i2);
    if (typeof t2 == `number`)
      return t2 &= 255, typeof Uint8Array.prototype.indexOf == `function` ? i2 ? Uint8Array.prototype.indexOf.call(e3, t2, n2) : Uint8Array.prototype.lastIndexOf.call(e3, t2, n2) : w(e3, [t2], n2, r3, i2);
  ...
  function w(e3, t2, n2, r3, i2) {
    ...
    if (i2) {
      let r4 = -1;
      for (l2 = n2; l2 < o2; l2++)
        if (c2(e3, l2) === c2(t2, r4 === -1 ? 0 : l2 - r4)) {
          if (r4 === -1 && (r4 = l2), l2 - r4 + 1 === s2)
            return r4 * a2;
        } else
          r4 !== -1 && (l2 -= l2 - r4), r4 = -1;
    } else
      for (n2 + s2 > o2 && (n2 = o2 - s2), l2 = n2; l2 >= 0; l2--) {
        let n3 = true;
        for (let r4 = 0; r4 < s2; r4++)
          if (c2(e3, l2 + r4) !== c2(t2, r4)) {
            n3 = false;
            break;
          }
        if (n3)
  ...
  l.prototype.write = function(e3, t2, n2, r3) {
    if (t2 === void 0)
      r3 = `utf8`, n2 = this.length, t2 = 0;
    else if (n2 === void 0 && typeof t2 == `string`)
      r3 = t2, n2 = this.length, t2 = 0;
    else if (isFinite(t2))
      t2 >>>= 0, isFinite(n2) ? (n2 >>>= 0, r3 === void 0 && (r3 = `utf8`)) : (r3 = n2, n2 = void 0);
    else
      throw Error(`Buffer.write(string, encoding, offset[, length]) is no longer supported`);
    let i2 = this.length - t2;
    if ((n2 === void 0 || n2 > i2) && (n2 = i2), e3.length > 0 && (n2 < 0 || t2 < 0) || t2 > this.length)
    ...
    for (; ; )
      switch (r3) {
        ...
        default:
          if (a2)
            throw TypeError(`Unknown encoding: ` + r3);
  ...
  function O(e3) {
    ...
    let n2 = ``, r3 = 0;
    for (; r3 < t2; )
      n2 += String.fromCharCode.apply(String, e3.slice(r3, r3 += D));
    return n2;
  }
  function k(e3, t2, n2) {
    let r3 = ``;
    ...
    for (let i2 = t2; i2 < n2; ++i2)
      r3 += String.fromCharCode(e3[i2] & 127);
    return r3;
  }
  function A(e3, t2, n2) {
    let r3 = ``;
  ...
  function M(e3, t2, n2) {
    ...
    for (let e4 = 0; e4 < r3.length - 1; e4 += 2)
      i2 += String.fromCharCode(r3[e4] + r3[e4 + 1] * 256);
    return i2;
  }
  ...
  l.prototype.writeUintLE = l.prototype.writeUIntLE = function(e3, t2, n2, r3) {
    ...
    let i2 = 1, a2 = 0;
    for (this[t2] = e3 & 255; ++a2 < n2 && (i2 *= 256); )
      this[t2 + a2] = e3 / i2 & 255;
    return t2 + n2;
    ...
    let i2 = n2 - 1, a2 = 1;
    for (this[t2 + i2] = e3 & 255; --i2 >= 0 && (a2 *= 256); )
      this[t2 + i2] = e3 / a2 & 255;
    return t2 + n2;
  ...
  l.prototype.writeBigUInt64LE = $(function(e3, t2 = 0) {
    ...
    let i2 = 0, a2 = 1, o2 = 0;
    for (this[t2] = e3 & 255; ++i2 < n2 && (a2 *= 256); )
      e3 < 0 && o2 === 0 && this[t2 + i2 - 1] !== 0 && (o2 = 1), this[t2 + i2] = (e3 / a2 >> 0) - o2 & 255;
    return t2 + n2;
  ...
  l.prototype.writeDoubleLE = function(e3, t2, n2) {
    ...
    if (n2 || (n2 = 0), !r3 && r3 !== 0 && (r3 = this.length), t2 >= e3.length && (t2 = e3.length), t2 || (t2 = 0), r3 > 0 && r3 < n2 && (r3 = n2), r3 === n2 || e3.length === 0 || this.length === 0)
      return 0;
    if (t2 < 0)
    ...
    if (typeof e3 == `string`) {
      if (typeof t2 == `string` ? (r3 = t2, t2 = 0, n2 = this.length) : typeof n2 == `string` && (r3 = n2, n2 = this.length), r3 !== void 0 && typeof r3 != `string`)
        throw TypeError(`encoding must be a string`);
      if (typeof r3 == `string` && !l.isEncoding(r3))
        throw TypeError(`Unknown encoding: ` + r3);
      if (e3.length === 1) {
    ...
    if (typeof e3 == `number`)
      ...
      if (o2 === 0)
        throw TypeError(`The value "` + e3 + `" is invalid for argument "value"`);
  ...
  function G(e3, t2) {
    if (typeof e3 != `number`)
      throw new B.ERR_INVALID_ARG_TYPE(t2, `number`, e3);
  }
  function K(e3, t2, n2) {
  ...
  var q = /[^+/0-9A-Za-z-_]/g;
  function oe(e3) {
    if (e3 = e3.split(`=`)[0], e3 = e3.trim().replace(q, ``), e3.length < 2)
      return ``;
    for (; e3.length % 4 != 0; )
      e3 += `=`;
    return e3;
  ...
  function se(e3) {
    ...
    for (let n2 = 0; n2 < e3.length; ++n2)
      t2.push(e3.charCodeAt(n2) & 255);
    return t2;
  }
  function ce(e3, t2) {
    let n2, r3, i2, a2 = [];
    for (let o2 = 0; o2 < e3.length && !((t2 -= 2) < 0); ++o2)
      n2 = e3.charCodeAt(o2), r3 = n2 >> 8, i2 = n2 % 256, a2.push(i2), a2.push(r3);
    return a2;
  }
  function Y(e3) {
  ...
  function X(e3, t2, n2, r3) {
    let i2;
    for (i2 = 0; i2 < r3 && !(i2 + n2 >= t2.length || i2 >= e3.length); ++i2)
      t2[i2 + n2] = e3[i2];
    return i2;
  }
  function Z(e3, t2) {
