...
var t = e(((e2, t2) => {
  ...
  Object.defineProperty(s, `defaultMaxListeners`, { enumerable: true, get: function() {
    ...
    if (typeof e3 != `number` || e3 < 0 || o(e3)) throw RangeError(`The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ` + e3 + `.`);
    c = e3;
  } }), s.init = function() {
    (this._events === void 0 || this._events === Object.getPrototypeOf(this)._events) && (this._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0), this._maxListeners = this._maxListeners || void 0;
  }, s.prototype.setMaxListeners = function(e3) {
    if (typeof e3 != `number` || e3 < 0 || o(e3)) throw RangeError(`The value of "n" is out of range. It must be a non-negative number. Received ` + e3 + `.`);
  ...
  s.prototype.getMaxListeners = function() {
    ...
    for (var t3 = [], n2 = 1; n2 < arguments.length; n2++) t3.push(arguments[n2]);
    var i2 = e3 === `error`, a2 = this._events;
    if (a2 !== void 0) i2 &&= a2.error === void 0;
    ...
    if (typeof c2 == `function`) r(c2, this, t3);
    else for (var l2 = c2.length, u2 = g(c2, l2), n2 = 0; n2 < l2; ++n2) r(u2[n2], this, t3);
    return true;
  };
  function d(e3, t3, n2, r2) {
    var i2, o2, s2;
    if (l(n2), o2 = e3._events, o2 === void 0 ? (o2 = e3._events = /* @__PURE__ */ Object.create(null), e3._eventsCount = 0) : (o2.newListener !== void 0 && (e3.emit(`newListener`, t3, n2.listener ? n2.listener : n2), o2 = e3._events), s2 = o2[t3]), s2 === void 0) s2 = o2[t3] = n2, ++e3._eventsCount;
  ...
  s.prototype.once = function(e3, t3) {
    ...
    var n2, r2, i2, a2, o2;
    if (l(t3), r2 = this._events, r2 === void 0 || (n2 = r2[e3], n2 === void 0)) return this;
    if (n2 === t3 || n2.listener === t3) --this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : (delete r2[e3], r2.removeListener && this.emit(`removeListener`, e3, n2.listener || t3));
    else if (typeof n2 != `function`) {
      for (i2 = -1, a2 = n2.length - 1; a2 >= 0; a2--) if (n2[a2] === t3 || n2[a2].listener === t3) {
    ...
    if (arguments.length === 0) {
      ...
      for (r2 = 0; r2 < i2.length; ++r2) a2 = i2[r2], a2 !== `removeListener` && this.removeAllListeners(a2);
      return this.removeAllListeners(`removeListener`), this._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0, this;
    }
    if (t3 = n2[e3], typeof t3 == `function`) this.removeListener(e3, t3);
    else if (t3 !== void 0) for (r2 = t3.length - 1; r2 >= 0; r2--) this.removeListener(e3, t3[r2]);
    return this;
  };
  function m(e3, t3, n2) {
    var r2 = e3._events;
  ...
  function g(e3, t3) {
    for (var n2 = Array(t3), r2 = 0; r2 < t3; ++r2) n2[r2] = e3[r2];
    return n2;
  }
  function _(e3, t3) {
  ...
  function v(e3) {
    for (var t3 = Array(e3.length), n2 = 0; n2 < t3.length; ++n2) t3[n2] = e3[n2].listener || e3[n2];
    return t3;
  }
  function y(e3, t3) {
  ...
  function x(e3, t3, n2, r2) {
    if (typeof e3.on == `function`) r2.once ? e3.once(t3, n2) : e3.on(t3, n2);
    else if (typeof e3.addEventListener == `function`) e3.addEventListener(t3, function i2(a2) {
