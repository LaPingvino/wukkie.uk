class WukkieApp {
    ...
    setupEventListeners() {
        ...
        document.getElementById('location').addEventListener('input', (e) => this.geocodeLocation(e.target.value));
    }
    ...
    async getCurrentLocation() {
        ...
        navigator.geolocation.getCurrentPosition(
            ...
            (error) => {
                ...
                this.showStatus('Failed to get location. Please enter manually.', 'error');
                button.textContent = originalText;
                button.disabled = false;
            },
            {
    ...
    async loadIssues() {
        ...
        try {
            ...
            const mockIssues = [
                {
                    ...
                    priority: "medium",
                    location: { address: "Dam Square, Amsterdam", lat: 52.3732, lng: 4.8936 },
                ...
                },
                {
                    ...
                    category: "transport",
                    priority: "high",
                    location: { address: "Vondelpark, Amsterdam", lat: 52.3579, lng: 4.8686 },
            ...
            listEl.innerHTML = '<p class="loading">Failed to load issues. Please refresh to try again.</p>';
        }
    ...
    displayIssues(issues) {
        ...
        listEl.innerHTML = issues.map(issue => {
            const distance = this.userLocation ?
                this.calculateDistance(this.userLocation, issue.location) : null;
